...
execute_process(
  COMMAND "C:/devkitPro/msys2/usr/bin/git.exe" --git-dir=.git show-ref "master"
  WORKING_DIRECTORY "C:/Users/nukec/Documents/GitHub/voxelstation13/build_ninja/_deps/stb-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/nukec/Documents/GitHub/voxelstation13/build_ninja/_deps/stb-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/nukec/Documents/GitHub/voxelstation13/build_ninja/_deps/stb-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

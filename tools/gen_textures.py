...
TEXTURES = {
    ...
    "textures/items/fire_extinguisher.png":solid(W, H, 200, 40,  40),
    "textures/items/cable_coil.png":       solid(W, H, 220, 200, 40),
    "textures/items/metal_sheet.png":      solid(W, H, 160, 170, 180),
    "textures/items/glass_sheet.png":      solid(W, H, 140, 200, 230),
    "textures/items/flashlight.png":       solid(W, H, 230, 220, 100),
    "textures/items/medipen.png":          solid(W, H, 80,  180, 220),
    "textures/items/pill_bottle.png":      solid(W, H, 220, 140, 60),
    "textures/items/bandage.png":          solid(W, H, 240, 230, 220),
    # Equipment
    "textures/items/hardsuit.png":         solid(W, H, 60,  80,  70),
    "textures/items/hardsuit_helmet.png":  solid(W, H, 50,  70,  60),
    "textures/items/mining_helmet.png":    solid(W, H, 210, 180, 40),
    "textures/items/welding_helmet.png":   solid(W, H, 160, 90,  40),
    "textures/items/welding_goggles.png":  solid(W, H, 180, 110, 50),
    "textures/items/jetpack.png":          solid(W, H, 40,  70,  160),
    "textures/items/oxygen_tank.png":      solid(W, H, 200, 220, 240),
    "textures/items/backpack.png":         solid(W, H, 120, 90,  60),
    "textures/items/toolbelt.png":         solid(W, H, 90,  60,  30),
    "textures/items/insulated_gloves.png": solid(W, H, 220, 200, 50),
    "textures/items/rubber_gloves.png":    solid(W, H, 40,  130, 110),
    "textures/items/magboots.png":         solid(W, H, 80,  90,  110),
    "textures/items/boots.png":            solid(W, H, 110, 80,  50),
    "textures/items/headset.png":          solid(W, H, 30,  30,  35),
    "textures/items/gas_mask.png":         solid(W, H, 70,  100, 70),
    "textures/items/sunglasses.png":       solid(W, H, 30,  60,  100),
    # Containers
    "textures/items/satchel.png":          solid(W, H, 160, 130, 90),
    "textures/items/duffel_bag.png":       solid(W, H, 80,  100, 70),
    "textures/items/briefcase.png":        solid(W, H, 80,  60,  40),
    "textures/items/secure_briefcase.png": solid(W, H, 60,  60,  70),
    "textures/items/medical_kit.png":      solid(W, H, 230, 230, 230),
    "textures/items/storage_crate.png":    solid(W, H, 140, 120, 90),
